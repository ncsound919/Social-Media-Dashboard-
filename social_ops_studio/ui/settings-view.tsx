...
type SettingsTab = 'profile' | 'accounts' | 'notifications' | 'appearance' | 'security' | 'data';
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {activeTab === 'data' && (
          <div className="glass-card p-6">
            ...
            <div className="space-y-4 max-w-md">
              <div className="p-4 rounded-lg bg-surface">
                <p className="font-medium mb-2">Local Storage Used</p>
                <div className="w-full h-2 bg-background rounded-full overflow-hidden mb-2">
                  <div className="h-full bg-accent-cyan w-[35%]" />
                </div>
                <p className="text-sm text-text-secondary">35 MB of 100 MB used</p>
              </div>
              
              <div className="p-4 rounded-lg bg-surface">
                <p className="font-medium mb-3">Export Data</p>
                <button className="btn-secondary text-sm">Download All Data</button>
              </div>
